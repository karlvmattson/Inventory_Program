...
public class AddProductMenuController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //tableViewPartsInProduct should start empty when adding a new Product.
        tableViewPartsList.getItems().setAll(inventory.getAllParts());
    }

    public AddProductMenuController(Inventory inventory) throws IOException {
        ...
        //load our fxml file
        FXMLLoader loader = new FXMLLoader(getClass().getResource("AddProductMenu.fxml"));
    ...
    private void handleAddPartEvent(ActionEvent event) {
        ...
        selectedPart = tableViewPartsList.getSelectionModel().getSelectedItem();

        //Add part to second tableview
        tableViewPartsInProduct.getItems().add(selectedPart);
    }
    ...
    private void handleCancelEvent(ActionEvent event) throws IOException {
        ...
        confirmDialog.setContentText("Do you wish to cancel adding a product?");
    ...
    private void handleSaveEvent(ActionEvent event) throws IOException {
        ...
        //Create new Product
        Product newProduct = new Product(++maxId, newName, newPrice, newStock, newMin, newMax);
